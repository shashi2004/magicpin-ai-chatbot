...
# Choose your LLM provider: "openai", "nvidia", "anthropic", "gemini", "deepseek", "groq", "ollama", "openrouter"
LLM_PROVIDER = "openai"
...
# Environment variables override the hardcoded config above, so real API keys
# never need to be typed into this tracked file (or committed to git).
...
class NvidiaNIMProvider(OpenAIProvider):
    """NVIDIA's build.nvidia.com NIM endpoint — OpenAI-compatible chat completions API."""
    def __init__(self, api_key: str, model: str = ""):
        super().__init__(api_key, model or "meta/llama-3.1-70b-instruct",
...
def create_provider() -> LLMProvider:
    ...
    providers = {
        "openai": lambda: OpenAIProvider(LLM_API_KEY, LLM_MODEL, LLM_BASE_URL),
        "nvidia": lambda: NvidiaNIMProvider(LLM_API_KEY, LLM_MODEL),
